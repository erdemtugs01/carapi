...
ActiveRecord::Schema.define(version: 2020_12_17_041050) do
  ...
  create_table "citizen_vehicles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "citizen_id", null: false
    t.bigint "vehicle_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["citizen_id"], name: "index_citizen_vehicles_on_citizen_id"
    t.index ["vehicle_id"], name: "index_citizen_vehicles_on_vehicle_id"
  end
  ...
  add_foreign_key "citizen_vehicles", "citizens"
  add_foreign_key "citizen_vehicles", "vehicles"
end
